...
function YearsInBusinessAnswer() {
  ...
  useEffect(() => {
    ...
    // No need for cleanup or dependencies as this only runs once
  }, []);
...
const faqData: FAQItem[] = [
  // General Questions
  {
    ...
    answer: React.createElement(YearsInBusinessAnswer),
    category: "general"
  },
  {
