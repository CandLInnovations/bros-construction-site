...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    description: `Expert roofing services in Salt Lake City and the Wasatch Front. Specializing in metal roofing, asphalt shingles, composite shake, flat roofing (TPO/EPDM), custom metal siding, and roof repairs. ${yearsInBusiness}+ years of experience. Licensed & insured. Free estimates. Call (801) 867-0576.`,
    keywords: [
    ...
    openGraph: {
      ...
      description: `${yearsInBusiness}+ years of expert roofing services. Metal roofing, asphalt shingles, composite shake, flat roofing, custom metal siding, and repairs. Licensed & insured. Serving Salt Lake City and the Wasatch Front. Free estimates.`,
    ...
    twitter: {
      ...
      description: `${yearsInBusiness}+ years of expert roofing services. Metal roofing, asphalt shingles, custom siding, and more. Licensed & insured.`,
